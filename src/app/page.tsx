      ...
      {view === "list" ? (
        ...
        <div className="max-w-lg mx-auto px-4 pt-6 pb-24">
          ...
          <div className="bg-white rounded-xl border border-slate-200/80 p-5 mb-4 shadow-sm">
            ...
            <button
              onClick={addItem}
              className="w-full mt-3 py-3 border-2 border-dashed border-slate-200 rounded-xl text-slate-400 font-medium hover:border-indigo-300 hover:text-indigo-500 hover:bg-indigo-50/30 transition-all duration-150 min-h-[48px]"
            >
              + Add Item
            </button>
          </div>
